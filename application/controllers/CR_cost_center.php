...
class CR_cost_center extends CI_Controller
{
	...
	function index()
	{
		$data['judul']     = 'Cost Center';
		$data['load_grid'] = 'CR_cost_center';
		$data['company']      = $this->company . ' - ' . $this->cp_name;
		$this->load->view("VR_report/VR_cost_center", $data);
	}
	...
	public function Report()
	{
		...
		// OUTPUT
		// ==============================
		$filename = 'laporan_cost_center_' . date('Ymd_His') . '.xlsx';
