			...
			<div class="row">
				...
				<div class="col-6">
					<div class="mb-3">
						...
						<select id="type_report" name="type_report" class="form-control-hover-light form-control select2"
							data-parsley-required="true" data-parsley-errors-container=".err_type_report" required="">
							<option value="">Pilih</option>
							<option value="NRH">NRH - Neraca Header</option>
							<option value="NRD">NRD - Neraca Header</option>
						</select>
						<span class="text-danger err_type_report"></span>
					</div>
				</div>
...
<script>
	...
	$('#btnsubmit').click(function(e) {
		...
		const type_report = encodeURIComponent($("#type_report").val());
		...
		const url = "<?= base_url('CR_balance_sheet/Report') ?>?" +
